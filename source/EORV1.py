...
def get_edit_key():
    print("Press the key you want to use for editing (e.g., 'C'). Press 'esc' to cancel.")
    ...
    while True:
        ...
        try:
            ...
            if event.event_type == keyboard.KEY_DOWN and event.name not in ('esc',):
...
def simulate_edit_on_release(edit_key):
    ...
    print(f"Simulating Edit on Release for key '{edit_key}'. Press 'esc' to exit.")
